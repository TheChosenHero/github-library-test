...
build 30 (Oct 30, 2016)
- ICA fix subframe height
- delayed device initialization introduced
- JNLP deployment example introduced
build 31 (Oct 24, 2017)
- sun.misc.BASE64Decoder dependency removed to work with JDK9 

----------------------------------------------------------------

Morena 7 - Image Acquisition Framework

Copyright (c) 1999-2017 Gnome spol. s r.o. All Rights Reserved.
